  ...
  return (
    ...
    >
      <body className="min-h-full app-backdrop">
        ...
        <div className="relative mx-auto flex min-h-dvh w-full max-w-[480px] flex-col overflow-hidden bg-cream shadow-[0_0_80px_-20px_rgba(45,20,80,0.25)] sm:my-6 sm:min-h-[calc(100dvh-3rem)] sm:rounded-[32px] sm:border sm:border-white/60">
